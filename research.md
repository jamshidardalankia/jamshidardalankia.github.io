...
[Home](./) | [Research](research) | [Publications](publications) | [CV](cv) | [Teaching](teaching) | [Code](code) | [Contact](contact)

---

## Research Interests

- Financial multilayer and hypergraph networks  
- Systemic risk, contagion, and crisis detection  
- Market microstructure and trading-value spillovers  
- Network-based portfolio construction and risk parity  
- AI, big data, and network methods in finance
...
- Multilayer network of assets with separate price and trading-value layers  
- Similarity-based hierarchical clustering generalized to capture cross-layer spillovers  
...
- Hypergraph models for ETF–asset and fund–holding structures  
- Network-based macro–finance models linking firm networks, credit, and monetary policy  
- Integration of graph neural networks with structural financial network models
